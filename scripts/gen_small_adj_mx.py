...
def get_small_matrix(adj_mx, sensor_to_ind):
    pdb.set_trace()  ## There are totally 207 nodes in your big matrix, what if we want a small matrix and node;
...
if __name__ == '__main__':
    ...
    generate_small_adj = get_small_matrix(adj_mx, sensor_id_to_ind)
